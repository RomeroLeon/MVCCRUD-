...
namespace MVCCRUD_.Controllers
{
    public class CarrerasController : Controller
    {
        ...
        public CarrerasController(MvccrudContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Carreras != null ? 
                          ...
                          Problem("Entity set 'MvccrudContext.Carreras'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("CarreraId,NombreCarrera,FacultadId")] Carrera carrera)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarreraId,NombreCarrera,FacultadId")] Carrera carrera)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvccrudContext.Carreras'  is null.");
            }
            var carrera = await _context.Carreras.FindAsync(id);
            if (carrera != null)
            {
