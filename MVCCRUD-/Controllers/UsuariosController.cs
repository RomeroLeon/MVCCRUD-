...
namespace MVCCRUD_.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UsuarioId,Nombre,Documento,Tipo,Carnet,CarreraId")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UsuarioId,Nombre,Documento,Tipo,Carnet,CarreraId")] Usuario usuario)
        {
